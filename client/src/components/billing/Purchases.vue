<template>
  <div>
    ...
    <v-card style="margin-top:15px">
      <v-data-table light :loading="account.billing === undefined" :headers="headers" :items="items" :search="search" :options="{itemsPerPage: 3}" :footer-props="{'items-per-page-options':[3, 6, 12, -1]}" :hide-default-footer="items.length == 0" no-data-text="No payments done">
